...
class NexusCleaner:
    ...
    def __init__(self):
        self.ChkKeep_fl = 0
        self.ChkDays_fl = 0
        self.NEXUS_ADDRESS = None
        self.NEXUS_PORT = None
        self.NEXUS_USER_LOGIN = None
        self.NEXUS_USER_PASSWORD = None
    ...
    def _check_nexus_images(self, RepoName='', ImageName='', ImageVersion=''):
        ...
        search_url = 'https://{0}:{1}/service/rest/v1/search'.format(
            self.NEXUS_ADDRESS,
            self.NEXUS_PORT)
    ...
    def _get_all_image_names(self, RepoName=''):
        ...
        print(params)
        search_url = 'https://{0}:{1}/service/rest/v1/search'.format(self.NEXUS_ADDRESS, self.NEXUS_PORT)
